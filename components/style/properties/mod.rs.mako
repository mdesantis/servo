    ...
    <%self:longhand name="line-height">
        ...
        pub fn parse(_context: &ParserContext, input: &mut Parser) -> Result<SpecifiedValue, ()> {
            ...
            match try!(input.next()) {
                ...
                Token::Percentage(ref value) if value.value >= 0. => {
...
//            }
    ...
    <%self:longhand name="box-shadow">
        ...
        fn parse_one_box_shadow(input: &mut Parser) -> Result<SpecifiedBoxShadow, ()> {
            use servo_util::geometry::Au;
    ...
    <%self:longhand name="clip">
        ...
        pub fn parse(_context: &ParserContext, input: &mut Parser) -> Result<SpecifiedValue, ()> {
            ...
            let sides = try!(input.parse_nested_block().parse_comma_separated(|input| {
                if input.expect_ident_matching("auto").is_ok() {
                    Ok(None)
                } else {
...
pub fn parse_style_attribute(input: &str, base_url: &Url) -> PropertyDeclarationBlock {
    Parser::parse_str(input, |parser| {
        let context = ParserContext {
            stylesheet_origin: Origin::Author,
            base_url: base_url,
            namespaces: NamespaceMap::new(),
        };
        parse_property_declaration_list(&context, parser)
    })
}
