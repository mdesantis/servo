...
pub fn parse_author_origin_selector_list_from_str(input: &str)
    ...
    Parser::parse_str(input, |parser| parse_selector_list(&context, parser))
...
fn parse_one_simple_selector(context: &ParserContext,
    ...
    match input.next_including_whitespace() {
        ...
        Ok(Token::SquareBracketBlock) => {
            let attr = try!(input.parse_nested_block().parse_entirely(|input| {
        ...
        Ok(Token::Colon) => {
            match input.next_including_whitespace() {
                ...
                Ok(Token::Function(name)) => {
                    ...
                    let pseudo = try!(input.parse_nested_block().parse_entirely(|input| {
